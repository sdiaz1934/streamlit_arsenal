...
if opt == 'Introduction':
    with introduction:
        ...
        sl.subheader('*Description of the database*')
...
if opt == 'Objective of the Project':
    with homepage:
        ...
        sl.subheader('*Specific objectives*')
...
if opt == 'Methodology':
    with methodology:
        ...
        sl.subheader('*Importing libraries and database*')
        code_modules = ("""
                import warnings
        ...
        sl.subheader('*Removing unnecessary information*')
        ...
        sl.subheader('*Identifying and/or deleting duplicate values and NaN management*')
        ...
        sl.subheader('*Adjusting the data*')
...
| Tottenham Hotspur | London |
                """)
        sl.subheader("*Predictive modeling*")
...
if opt == 'Analysis and Results':
    with analysis_results:
        ...
        sl.subheader('Performance of the English Premier League’s Teams')
